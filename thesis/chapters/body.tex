...
Make sure to format your citations properly using the \texttt{natbib} package, as shown in the main thesis file. For instance, you can cite a source like this \cite{author2020study}
